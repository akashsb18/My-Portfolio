...
const Portfolio = () => {
    ...
    return (
        <div
            name="portfolio"
            className="bg-gradient-to-b from-black to-gray-800 w-full text-white h-screen dark:text-black dark:bg-gradient-to-b dark:from-stone-300 dark:to-stone-300"
        >
